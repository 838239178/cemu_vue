        ...
        <el-carousel height="236px" style="width: 505px">
          <el-carousel-item v-for="item in hotGame" :key="item.id">
            <el-image
              fit="fill"
              :src="item.pics[0]"
              @click="linkto(`/gamedetail?id=${item.id}`)"
              class="w420px h236"
            />
          </el-carousel-item>
        </el-carousel>
        ...
        >
          ...
          <template v-for="i in curReports" :key="i.id">
            <PostCardItem
              ...
              @click="linkto(`/postdetail?id=${i.id}`,150)"
            ></PostCardItem>
          </template>
        </div>
      </div>
      ...
      >
        ...
        <template v-for="(p, idx) in curEvals" :key="idx">
          <PostCardItem
            ...
            @click="linkto(`/postdetail?id=${p.id}`,150)"
          />
        </template>
      </div>
