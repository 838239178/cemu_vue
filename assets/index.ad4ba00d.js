import{r as d,o as p,c as u,w as j,v as C,a as f,n as P,b as r,d as m,e as R,F as x,f as k,t as _,T as V,g as G,h as A,i as O,j as U,z as $,l as F,_ as z,k as J,m as B}from"./vendor.e241ceec.js";const H=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerpolicy&&(a.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?a.credentials="include":o.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}};H();var q="/cemu_vue/assets/logo.0c747f41.png";class M{constructor(){this.isLock=!1,this.lockList=[]}async getLock(){let e=this;function n(){let s=e.lockList.shift();s?s.resolve(n):e.isLock=!1}return this.isLock?new Promise((s,o)=>{this.lockList.push({resolve:s,reject:o})}):(this.isLock=!0,n)}}var b=(t,e)=>{for(const[n,s]of e)t[n]=s;return t};const W={props:{iptClass:{default:()=>""},placeholder:{default:()=>""},getHints:{type:Function},throttle:{default:()=>200},maxRes:{default:()=>5}},data(){return{showList:!1,hintList:[],value:"",keywordStack:[],throttleTimer:null,preshow:0,lock:new M}},methods:{doThrottle(){let t=new Date().getTime(),e=t-this.preshow;return this.preshow=t,e<=this.throttle},async onInput(t){let e=await this.lock.getLock();this.keywordStack.push(this.value),e(),!this.doThrottle()&&this.doSearch(this.value)},doSearch(t){this.showList=!0,this.hintList=this.getHints(t).slice(0,this.maxRes)},onFocusout(t){setTimeout(()=>{this.showList=!1},150),clearInterval(this.throttleTimer),this.throttleTimer=null,this.keywordStack=[]},onFocusin(t){this.throttleTimer=setInterval(async()=>{let e=await this.lock.getLock();if(this.keywordStack.length==0||this.doThrottle()){e();return}let n=this.keywordStack.pop();this.keywordStack=[],e(),this.doSearch(n)},this.throttle)},clickSearch(t){this.value=t,console.log(this.value)}}},K={class:"relative"},Q=["placeholder"],X={class:"mt-1 px-3 border-b border-l border-r rounded w-11/12 ml-2 h-fit grid grid-cols-1 divide-y divide-primary-gray",style:{"background-color":"inherit",color:"inherit","border-color":"inherit","box-shadow":"3px 5px 15px #333333"}},Y=["onClick"];function Z(t,e,n,s,o,a){const i=d("font-awesome-icon");return p(),u("div",K,[j(f("input",{"onUpdate:modelValue":e[0]||(e[0]=c=>o.value=c),type:"text",class:P(["bg-none border-none p-0 m-0 w-full h-full s-input px-4",n.iptClass]),placeholder:n.placeholder,onChange:e[1]||(e[1]=c=>a.doSearch(o.value)),onFocusin:e[2]||(e[2]=(...c)=>a.onFocusin&&a.onFocusin(...c)),onInput:e[3]||(e[3]=(...c)=>a.onInput&&a.onInput(...c)),onFocusout:e[4]||(e[4]=(...c)=>a.onFocusout&&a.onFocusout(...c))},null,42,Q),[[C,o.value]]),r(i,{class:"absolute right-4 top-1 hover:text-primary-red transition hover:scale-105 duration-200",icon:"search"}),r(V,{name:"el-zoom-in-top"},{default:m(()=>[j(f("div",X,[(p(!0),u(x,null,k(o.hintList,(c,l)=>(p(),u("button",{onClick:h=>a.clickSearch(c),key:l,style:{"font-size":"inherit"},class:"px-4 py-4 w-full text-left"},_(c),9,Y))),128))],512),[[R,o.showList]])]),_:1})])}var ee=b(W,[["render",Z],["__scopeId","data-v-41d8a87a"]]);const te={emits:["linkto","update:modelValue"],props:{opts:{default:()=>[]},modelValue:{default:()=>0}},watch:{modelValue(t){this.selectedIndex=t}},data(){return{tab:"hover:text-white transition duration-300",selectedIndex:this.modelValue}},methods:{linktoEvent(t,e){this.selectedIndex=e,this.$emit("linkto",t,e),this.$emit("update:modelValue",e)}}},ne={class:"grid grid-flow-col grid-rows-1"},oe=["onClick"];function ae(t,e,n,s,o,a){const i=d("font-awesome-icon");return p(),u("div",ne,[(p(!0),u(x,null,k(n.opts,(c,l)=>(p(),u("button",{class:P(["antialiased",[o.tab,o.selectedIndex==l?"text-white font-semibold":""]]),key:l,onClick:h=>a.linktoEvent(c,l)},[f("span",null,[r(i,{icon:c.icon},null,8,["icon"]),G("\xA0\u2009"+_(c.text),1)])],10,oe))),128))])}var se=b(te,[["render",ae]]);const ie={emits:["quit-login"],props:{username:{default:()=>"LikeGhost"},avatar:{default:()=>"https://avatars.githubusercontent.com/u/55338151?v=4"}},data(){return{opts:[{text:"\u4E2A\u4EBA\u4E2D\u5FC3",icon:"user"},{text:"\u6536\u85CF\u5939",icon:"heart"},{text:"\u6D88\u606F\u901A\u77E5",icon:"envelope"}]}}},ce={class:"flex justify-between items-center mx-auto"},re={class:"grid grid-cols-1 divide-y divide-primary-gray"},de={class:"text-primary-gray cursor-pointer"};function le(t,e,n,s,o,a){const i=d("el-image"),c=d("font-awesome-icon"),l=d("el-popover");return p(),u("div",ce,[r(l,{placement:"bottom",width:"150px",trigger:"hover"},{reference:m(()=>[r(i,{class:"rounded-full w-8 h-8",src:n.avatar},null,8,["src"])]),default:m(()=>[f("div",re,[(p(!0),u(x,null,k(o.opts,h=>(p(),u("button",{key:h,class:"text-left px-4 py-4 active:bg-white flex justify-between items-center ripple"},[r(c,{class:"text-primary-red",icon:h.icon},null,8,["icon"]),G(" "+_(h.text),1)]))),128))])]),_:1}),f("div",de,_(n.username),1),r(c,{onClick:e[0]||(e[0]=h=>t.$emit("quit-login")),class:"text-primary-gray text-lg hover:text-white transition duration-200",icon:"sign-out-alt"})])}var pe=b(ie,[["render",le]]),ue=`{
    "data": [
        {
            "id": 0,
            "type": "eval",
...
}`;let v=JSON.parse(ue),y=JSON.parse(me),_e=JSON.parse(he),be=JSON.parse(ge),ve=JSON.parse(fe);var ye={getGameReports(t,e=0){return v.data.filter(n=>n.type=="report").slice(e,t)},getGameEvalByGame(t){return v.data.find(e=>e.gameId==t&&e.type=="eval")},getDeveloperMessage(t){return v.data.find(e=>e.gameId==t&&e.type=="devmsg")},getGameEvals(t,e=0){return v.data.filter(n=>n.type=="eval").slice(e,t)},getGameRanks(t,e=0){return y.data.sort((n,s)=>s.publicScore-n.publicScore).slice(e,t)},getGameData(t=null,e=0){return y.data.slice(e,t)},getGameDateById(t){return y.data.find(e=>e.id==t)},getHotGames(t){return y.data.sort((e,n)=>n.hotPoint-e.hotPoint).slice(0,t)},getAd(){return ve.data},getPostContent(t){return be.data.find(e=>e.id==t)},getGameComments(t){return _e.data.filter(e=>e.gameId==t)}};const we={data(){return{logoSrc:q,routeTable:new Map([["/index",{text:"\u9996\u9875",icon:"home"}],["/gamecenter",{text:"\u6E38\u620F\u4E2D\u5FC3",icon:"gamepad"}],["/rank",{text:"\u6392\u884C\u699C",icon:"crown"}]]),routeIndex:0}},watch:{$route(t,e){this.routeIndex=[...this.routeTable.keys()].findIndex(n=>n==t.path)}},methods:{routeTo(t,e){let n=[...this.routeTable.keys()];this.$router.push(n[e])},search(t){return ye.getGameData(5).filter(n=>{let s=new RegExp(`.*${t}.*`);return s.test(n.name)||s.test(n.desc)}).map(n=>n.name)}},components:{SearchBar:ee,PageTabs:se,UserPanel:pe}},xe={class:"bg-fixed bg-background min-h-full"},ke=f("div",{style:{"min-height":"60px"},class:"bg-none"},"cemu.com",-1),Ie={class:"p-0 h-full w-full"};function je(t,e,n,s,o,a){const i=d("el-col"),c=d("el-image"),l=d("PageTabs"),h=d("SearchBar"),L=d("UserPanel"),N=d("el-row"),E=d("el-header"),T=d("router-view"),D=d("el-container");return p(),u("div",xe,[r(D,{direction:"vertical",class:"h-full"},{default:m(()=>[ke,r(E,{height:"60px",class:"bg-primary-black text-primary-gray fixed w-full z-50"},{default:m(()=>[r(N,{gutter:0,class:"h-16",align:"middle",justify:"space-between"},{default:m(()=>[r(i,{span:4}),r(i,{span:2,offset:0},{default:m(()=>[r(c,{class:"w-12 h-12 cursor-pointer",onClick:e[0]||(e[0]=I=>a.routeTo("/index")),src:o.logoSrc},null,8,["src"])]),_:1}),r(i,{span:6,offset:0},{default:m(()=>[r(l,{class:"w-80 h-6 text-sm divide-x divide-primary-gray",onLinkto:a.routeTo,opts:[...o.routeTable.values()],modelValue:o.routeIndex,"onUpdate:modelValue":e[1]||(e[1]=I=>o.routeIndex=I),icons:["home","gamepad","crown"]},null,8,["onLinkto","opts","modelValue"])]),_:1}),r(i,{span:7,offset:0},{default:m(()=>[r(h,{class:"w480 h-7 text-sm bg-primary-black text-primary-gray border-primary-gray border-2 rounded-3xl",getHints:a.search,placeholder:"\u6218\u57302042\u9996\u53D1\u53E3\u7891\u5D29\u574F \u591A\u534A\u5DEE\u8BC4",iptClass:"focus:text-white"},null,8,["getHints"])]),_:1}),r(i,{span:3,offset:0},{default:m(()=>[r(L,{class:"bg-none w-48 h-8"})]),_:1}),r(i,{span:2})]),_:1})]),_:1}),f("div",Ie,[r(T)])]),_:1})])}var Pe=b(we,[["render",je]]);const Ge="modulepreload",S={},Se="/cemu_vue/",g=function(e,n){return!n||n.length===0?e():Promise.all(n.map(s=>{if(s=`${Se}${s}`,s in S)return;S[s]=!0;const o=s.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${a}`))return;const i=document.createElement("link");if(i.rel=o?"stylesheet":Ge,o||(i.as="script",i.crossOrigin=""),i.href=s,document.head.appendChild(i),o)return new Promise((c,l)=>{i.addEventListener("load",c),i.addEventListener("error",l)})})).then(()=>e())},Le=[{path:"/",redirect:"/index"},{path:"/index",component:()=>g(()=>import("./Index.d4fbb8ae.js"),["assets/Index.d4fbb8ae.js","assets/Index.6650512b.css","assets/RankCardItem.0f3351a6.js","assets/RankCardItem.fed1caed.css","assets/vendor.e241ceec.js"])},{path:"/login",component:()=>g(()=>import("./Login.594bd21a.js"),["assets/Login.594bd21a.js","assets/Login.4cba939f.css","assets/vendor.e241ceec.js"])},{path:"/community",component:()=>g(()=>import("./Community.62d555da.js"),[])},{path:"/compost",component:()=>g(()=>import("./Post.44a0ada6.js"),[])},{path:"/gamecenter",component:()=>g(()=>import("./GameCenter.02abc3d8.js"),["assets/GameCenter.02abc3d8.js","assets/vendor.e241ceec.js"])},{path:"/gamedetail",component:()=>g(()=>import("./GameDetail.ad78aad4.js"),["assets/GameDetail.ad78aad4.js","assets/GameDetail.a95ec2b4.css","assets/GameComment.7a18167a.js","assets/GameComment.8a518675.css","assets/vendor.e241ceec.js"])},{path:"/rank",component:()=>g(()=>import("./GameRank.88448c7b.js"),["assets/GameRank.88448c7b.js","assets/Pagination.60de65a9.js","assets/Pagination.44826ad1.css","assets/vendor.e241ceec.js"])},{path:"/test",component:()=>g(()=>import("./Test.b8545806.js"),["assets/Test.b8545806.js","assets/GameComment.7a18167a.js","assets/GameComment.8a518675.css","assets/vendor.e241ceec.js","assets/Pagination.60de65a9.js","assets/Pagination.44826ad1.css","assets/RankCardItem.0f3351a6.js","assets/RankCardItem.fed1caed.css"])}],Ne=A({history:O(),routes:Le});function Ee(t){t.use(U,{locale:$})}F.add(z);var Te=t=>{t.component("font-awesome-icon",J)};const w=B(Pe);Ee(w);Te(w);w.use(Ne);w.mount("#app");export{b as _,ye as a};
