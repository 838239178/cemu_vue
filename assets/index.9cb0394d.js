import{r as d,o as u,c as m,a as g,w as b,v as V,b as r,n as S,d as h,e as G,F as j,f as P,t as y,T as R,g as L,h as C,i as O,j as U,k as $,z as F,l as H,_ as z,m as J,p as B,V as q}from"./vendor.8394f990.js";const W=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerpolicy&&(a.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?a.credentials="include":n.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=o(n);fetch(n.href,a)}};W();var M="/cemu_vue/assets/logo.0c747f41.png";class K{constructor(){this.isLock=!1,this.lockList=[]}async getLock(){let e=this;function o(){let s=e.lockList.shift();s?s.resolve(o):e.isLock=!1}return this.isLock?new Promise((s,n)=>{this.lockList.push({resolve:s,reject:n})}):(this.isLock=!0,o)}}var x=(t,e)=>{const o=t.__vccOpts||t;for(const[s,n]of e)o[s]=n;return o};const Q={emits:["on-search","update:modelValue"],props:{iptClass:{default:()=>""},placeholder:{default:()=>""},modelValue:String,getHints:{type:Function},throttle:{default:()=>200},maxRes:{default:()=>5}},watch:{modelValue(t){this.value=t},value(t,e){this.$emit("update:modelValue",t,e)}},data(){return{showList:!1,hintList:[],value:this.modelValue||"",keywordStack:[],throttleTimer:null,preshow:0,lock:new K}},methods:{doThrottle(){let t=new Date().getTime(),e=t-this.preshow;return this.preshow=t,e<=this.throttle},async onInput(t){let e=await this.lock.getLock();this.keywordStack.push(this.value),e(),!this.doThrottle()&&this.searchHint(this.value)},searchHint(t){this.showList=!0,this.hintList=this.getHints(t).slice(0,this.maxRes)},onFocusout(t){setTimeout(()=>{this.showList=!1},150),clearInterval(this.throttleTimer),this.throttleTimer=null,this.keywordStack=[]},onFocusin(t){this.throttleTimer=setInterval(async()=>{let e=await this.lock.getLock();if(this.keywordStack.length==0||this.doThrottle()){e();return}let o=this.keywordStack.pop();this.keywordStack=[],e(),this.searchHint(o)},this.throttle)},clickSearch(t){this.value=t}}},X=["placeholder"],Y={class:"mt-1 px-3 border-b border-l border-r rounded w-11/12 ml-2 h-fit grid grid-cols-1 divide-y divide-primary-gray",style:{"background-color":"inherit",color:"inherit","border-color":"inherit","box-shadow":"3px 5px 15px #333333"}},Z=["onClick"];function ee(t,e,o,s,n,a){const i=d("font-awesome-icon");return u(),m("div",null,[g("div",{class:S(["flex justify-center items-center w-full h-full",o.iptClass])},[b(g("input",{"onUpdate:modelValue":e[0]||(e[0]=c=>n.value=c),type:"text",class:"bg-none border-none p-0 m-0 w-11/12 h-full s-input px-1",placeholder:o.placeholder,onChange:e[1]||(e[1]=c=>t.$emit("on-search",n.value)),onFocusin:e[2]||(e[2]=(...c)=>a.onFocusin&&a.onFocusin(...c)),onInput:e[3]||(e[3]=(...c)=>a.onInput&&a.onInput(...c)),onFocusout:e[4]||(e[4]=(...c)=>a.onFocusout&&a.onFocusout(...c))},null,40,X),[[V,n.value]]),r(i,{class:"w-1/12 hover:text-primary-red transition hover:scale-105 duration-200",icon:"search"})],2),r(R,{name:"el-zoom-in-top"},{default:h(()=>[b(g("div",Y,[(u(!0),m(j,null,P(n.hintList,(c,l)=>(u(),m("button",{onClick:_=>a.clickSearch(c),key:l,style:{"font-size":"inherit"},class:"px-4 py-4 w-full text-left"},y(c),9,Z))),128))],512),[[G,n.showList]])]),_:1})])}var te=x(Q,[["render",ee],["__scopeId","data-v-b3d3ef4c"]]);const ne={emits:["linkto","update:modelValue"],props:{opts:{default:()=>[]},modelValue:{default:()=>0}},watch:{modelValue(t){this.selectedIndex=t}},data(){return{tab:"hover:text-white transition duration-300",selectedIndex:this.modelValue}},methods:{linktoEvent(t,e){this.selectedIndex=e,this.$emit("linkto",t,e),this.$emit("update:modelValue",e)}}},oe={class:"grid grid-flow-col grid-rows-1"},ae=["onClick"];function se(t,e,o,s,n,a){const i=d("font-awesome-icon");return u(),m("div",oe,[(u(!0),m(j,null,P(o.opts,(c,l)=>(u(),m("button",{class:S(["antialiased",[n.tab,n.selectedIndex==l?"text-white font-semibold":""]]),key:l,onClick:_=>a.linktoEvent(c,l)},[g("span",null,[r(i,{icon:c.icon},null,8,["icon"]),L("\xA0\u2009"+y(c.text),1)])],10,ae))),128))])}var ie=x(ne,[["render",se]]);const ce={emits:["quit-login"],props:{username:{default:()=>"LikeGhost"},avatar:{default:()=>"https://avatars.githubusercontent.com/u/55338151?v=4"}},data(){return{opts:[{text:"\u4E2A\u4EBA\u4E2D\u5FC3",icon:"user"},{text:"\u6536\u85CF\u5939",icon:"heart"},{text:"\u6D88\u606F\u901A\u77E5",icon:"envelope"}]}}},re={class:"flex justify-between items-center mx-auto"},de={class:"grid grid-cols-1 divide-y divide-primary-gray"},le={class:"text-primary-gray cursor-pointer"};function pe(t,e,o,s,n,a){const i=d("el-image"),c=d("font-awesome-icon"),l=d("el-popover"),_=C("wave");return u(),m("div",re,[r(l,{placement:"bottom",width:"150px",trigger:"hover"},{reference:h(()=>[r(i,{class:"rounded-full w-8 h-8",src:o.avatar},null,8,["src"])]),default:h(()=>[g("div",de,[(u(!0),m(j,null,P(n.opts,f=>b((u(),m("button",{key:f,class:"text-left px-4 py-4 active:bg-white flex justify-between items-center"},[r(c,{class:"text-primary-red",icon:f.icon},null,8,["icon"]),L(" "+y(f.text),1)],512)),[[_]])),128))])]),_:1}),g("div",le,y(o.username),1),r(c,{onClick:e[0]||(e[0]=f=>t.$emit("quit-login")),class:"text-primary-gray text-lg hover:text-white transition duration-200",icon:"sign-out-alt"})])}var ue=x(ce,[["render",pe]]),me=`{
    "data": [
        {
            "id": 0,
            "type": "eval",
...
}`;let I=JSON.parse(me),w=JSON.parse(he),we=JSON.parse(ge),ve=JSON.parse(fe),be=JSON.parse(_e);var ye={getGameReports(t,e=0){return I.data.filter(o=>o.type=="report").slice(e,t)},getGameEvalByGame(t){return I.data.find(e=>e.gameId==t&&e.type=="eval")},getDeveloperMessage(t){return I.data.find(e=>e.gameId==t&&e.type=="devmsg")},getGameEvals(t,e=0){return I.data.filter(o=>o.type=="eval").slice(e,t)},getGameRanks(t,e=0){return w.data.sort((o,s)=>s.publicScore-o.publicScore).slice(e,t)},getGameData(t=null,e=0){return w.data.slice(e,t)},getGameDataAll(){return w.data},getGameDateById(t){return w.data.find(e=>e.id==t)},getHotGames(t){return w.data.sort((e,o)=>o.hotPoint-e.hotPoint).slice(0,t)},getAd(){return be.data},getPostContent(t){return ve.data.find(e=>e.id==t)},getGameComments(t){return we.data.filter(e=>e.gameId==t)}};const xe={data(){return{logoSrc:M,routeTable:new Map([["/index",{text:"\u9996\u9875",icon:"home"}],["/gamecenter",{text:"\u6E38\u620F\u4E2D\u5FC3",icon:"gamepad"}],["/rank",{text:"\u6392\u884C\u699C",icon:"crown"}]]),showSearch:!0,routeIndex:0}},watch:{$route(t,e){this.routeIndex=[...this.routeTable.keys()].findIndex(o=>o==t.path),t.path=="/search"?this.showSearch=!1:this.showSearch=!0}},methods:{routeTo(t,e){if(e!=null){let o=[...this.routeTable.keys()];this.$router.push(o[e])}else this.$router.push(t)},search(t){return ye.getGameData(5).filter(o=>{let s=new RegExp(`.*${t}.*`);return s.test(o.name)||s.test(o.desc)}).map(o=>o.name)}},components:{SearchBar:te,PageTabs:ie,UserPanel:ue}},Ie={class:"bg-fixed bg-background min-h-full"},ke=g("div",{style:{"min-height":"60px"},class:"bg-none"},"cemu.com",-1),je={class:"p-0 h-full w-full"};function Pe(t,e,o,s,n,a){const i=d("el-col"),c=d("el-image"),l=d("PageTabs"),_=d("SearchBar"),f=d("UserPanel"),A=d("el-row"),D=d("el-header"),N=d("router-view"),T=d("el-container");return u(),m("div",Ie,[r(T,{direction:"vertical",class:"h-full"},{default:h(()=>[ke,r(D,{height:"60px",class:"bg-primary-black text-primary-gray fixed w-full z-50"},{default:h(()=>[r(A,{gutter:0,class:"h-16",align:"middle",justify:"space-between"},{default:h(()=>[r(i,{span:3}),r(i,{span:2,offset:0},{default:h(()=>[r(c,{class:"w-12 h-12 cursor-pointer",onClick:e[0]||(e[0]=v=>a.routeTo("/index")),src:n.logoSrc},null,8,["src"])]),_:1}),r(i,{span:5,offset:0},{default:h(()=>[r(l,{class:"w-80 h-6 text-sm divide-x divide-primary-gray",onLinkto:a.routeTo,opts:[...n.routeTable.values()],modelValue:n.routeIndex,"onUpdate:modelValue":e[1]||(e[1]=v=>n.routeIndex=v),icons:["home","gamepad","crown"]},null,8,["onLinkto","opts","modelValue"])]),_:1}),r(i,{span:7,offset:0},{default:h(()=>[b(r(_,{class:"w480 h-7 text-sm bg-primary-black text-primary-gray border-primary-gray border-2 rounded-3xl",onOnSearch:e[2]||(e[2]=v=>a.routeTo(`/search?kw=${v}`)),getHints:a.search,placeholder:"\u6218\u57302042\u9996\u53D1\u53E3\u7891\u5D29\u574F \u591A\u534A\u5DEE\u8BC4",iptClass:"focus:text-white"},null,8,["getHints"]),[[G,n.showSearch]])]),_:1}),r(i,{span:3,offset:0},{default:h(()=>[r(f,{class:"bg-none w-48 h-8"})]),_:1}),r(i,{span:3})]),_:1})]),_:1}),g("div",je,[r(N)])]),_:1})])}var Se=x(xe,[["render",Pe]]);const Ge="modulepreload",E={},Le="/cemu_vue/",p=function(e,o){return!o||o.length===0?e():Promise.all(o.map(s=>{if(s=`${Le}${s}`,s in E)return;E[s]=!0;const n=s.endsWith(".css"),a=n?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${a}`))return;const i=document.createElement("link");if(i.rel=n?"stylesheet":Ge,n||(i.as="script",i.crossOrigin=""),i.href=s,document.head.appendChild(i),n)return new Promise((c,l)=>{i.addEventListener("load",c),i.addEventListener("error",l)})})).then(()=>e())},Ee=[{path:"/",component:()=>p(()=>import("./Welcome.f47c820e.js"),["assets/Welcome.f47c820e.js","assets/Welcome.c23ac3b0.css","assets/Index.63507cf5.js","assets/Index.6fac2589.css","assets/RankCardItem.4f566f2a.js","assets/RankCardItem.fed1caed.css","assets/vendor.8394f990.js","assets/CardTabs.433dc7df.js"])},{path:"/welcome",component:()=>p(()=>import("./Welcome.f47c820e.js"),["assets/Welcome.f47c820e.js","assets/Welcome.c23ac3b0.css","assets/Index.63507cf5.js","assets/Index.6fac2589.css","assets/RankCardItem.4f566f2a.js","assets/RankCardItem.fed1caed.css","assets/vendor.8394f990.js","assets/CardTabs.433dc7df.js"])},{path:"/index",component:()=>p(()=>import("./Index.63507cf5.js"),["assets/Index.63507cf5.js","assets/Index.6fac2589.css","assets/RankCardItem.4f566f2a.js","assets/RankCardItem.fed1caed.css","assets/vendor.8394f990.js","assets/CardTabs.433dc7df.js"])},{path:"/login",component:()=>p(()=>import("./Login.31df98bb.js"),["assets/Login.31df98bb.js","assets/slide-anim.13d7b7a7.css","assets/vendor.8394f990.js"])},{path:"/community",component:()=>p(()=>import("./Community.1fbae203.js"),["assets/Community.1fbae203.js","assets/Community.30b41276.css","assets/CardTabs.433dc7df.js","assets/vendor.8394f990.js","assets/Pagination.df6fdbaa.js","assets/Pagination.91b3dfc6.css"])},{path:"/postdetail",component:()=>p(()=>import("./Post.3f01ac06.js"),["assets/Post.3f01ac06.js","assets/Post.d8177493.css","assets/vendor.8394f990.js","assets/Pagination.df6fdbaa.js","assets/Pagination.91b3dfc6.css"])},{path:"/gamecenter",component:()=>p(()=>import("./GameCenter.503b8a8a.js"),["assets/GameCenter.503b8a8a.js","assets/GameCenter.f133fabd.css","assets/slide-anim.13d7b7a7.css","assets/GamesGuide.86de8647.js","assets/GamesGuide.fbcb9e48.css","assets/AnimNum.7d7e5893.js","assets/vendor.8394f990.js"])},{path:"/gamedetail",component:()=>p(()=>import("./GameDetail.139a7325.js"),["assets/GameDetail.139a7325.js","assets/GameDetail.2242cbbb.css","assets/GameComment.cd681ab2.js","assets/GameComment.43ca936f.css","assets/vendor.8394f990.js","assets/AnimNum.7d7e5893.js"])},{path:"/rank",component:()=>p(()=>import("./GameRank.0f85800b.js"),["assets/GameRank.0f85800b.js","assets/RankItem.85e7e2c7.js","assets/vendor.8394f990.js","assets/Pagination.df6fdbaa.js","assets/Pagination.91b3dfc6.css"])},{path:"/search",component:()=>p(()=>import("./Search.99721018.js"),["assets/Search.99721018.js","assets/Search.5ec92356.css","assets/slide-anim.13d7b7a7.css","assets/Pagination.df6fdbaa.js","assets/Pagination.91b3dfc6.css","assets/vendor.8394f990.js"])},{path:"/test",component:()=>p(()=>import("./Test.4aecf921.js"),["assets/Test.4aecf921.js","assets/GameComment.cd681ab2.js","assets/GameComment.43ca936f.css","assets/vendor.8394f990.js","assets/AnimNum.7d7e5893.js","assets/RankItem.85e7e2c7.js","assets/RankCardItem.4f566f2a.js","assets/RankCardItem.fed1caed.css","assets/Pagination.df6fdbaa.js","assets/Pagination.91b3dfc6.css","assets/GamesGuide.86de8647.js","assets/GamesGuide.fbcb9e48.css"])}],Ae=O({history:U(),routes:Ee});function De(t){t.use($,{locale:F})}H.add(z);var Ne=t=>{t.component("font-awesome-icon",J)};const k=B(Se);De(k);Ne(k);k.use(Ae).use(q);k.mount("#app");export{te as S,x as _,ye as a};
