import{r as d,o as p,c as m,w as j,v as C,a as f,n as P,b as r,d as u,e as R,F as x,f as k,t as b,T as A,g as G,h as V,i as O,j as U,z as $,l as F,_ as z,k as J,m as H}from"./vendor.434dc5a9.js";const B=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerpolicy&&(a.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?a.credentials="include":o.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}};B();var q="/cemu_vue/assets/logo.0c747f41.png";class W{constructor(){this.isLock=!1,this.lockList=[]}async getLock(){let e=this;function n(){let s=e.lockList.shift();s?s.resolve(n):e.isLock=!1}return this.isLock?new Promise((s,o)=>{this.lockList.push({resolve:s,reject:o})}):(this.isLock=!0,n)}}var v=(t,e)=>{for(const[n,s]of e)t[n]=s;return t};const M={props:{iptClass:{default:()=>""},placeholder:{default:()=>""},getHints:{type:Function},throttle:{default:()=>200},maxRes:{default:()=>5}},data(){return{showList:!1,hintList:[],value:"",keywordStack:[],throttleTimer:null,preshow:0,lock:new W}},methods:{doThrottle(){let t=new Date().getTime(),e=t-this.preshow;return this.preshow=t,e<=this.throttle},async onInput(t){let e=await this.lock.getLock();this.keywordStack.push(this.value),e(),!this.doThrottle()&&this.doSearch(this.value)},doSearch(t){this.showList=!0,this.hintList=this.getHints(t).slice(0,this.maxRes)},onFocusout(t){setTimeout(()=>{this.showList=!1},150),clearInterval(this.throttleTimer),this.throttleTimer=null,this.keywordStack=[]},onFocusin(t){this.throttleTimer=setInterval(async()=>{let e=await this.lock.getLock();if(this.keywordStack.length==0||this.doThrottle()){e();return}let n=this.keywordStack.pop();this.keywordStack=[],e(),this.doSearch(n)},this.throttle)},clickSearch(t){this.value=t,console.log(this.value)}}},K={class:"relative"},Q=["placeholder"],X={class:"mt-1 px-3 border-b border-l border-r rounded w-11/12 ml-2 h-fit grid grid-cols-1 divide-y divide-primary-gray",style:{"background-color":"inherit",color:"inherit","border-color":"inherit","box-shadow":"3px 5px 15px #333333"}},Y=["onClick"];function Z(t,e,n,s,o,a){const i=d("font-awesome-icon");return p(),m("div",K,[j(f("input",{"onUpdate:modelValue":e[0]||(e[0]=c=>o.value=c),type:"text",class:P(["bg-none border-none p-0 m-0 w-full h-full s-input px-4",n.iptClass]),placeholder:n.placeholder,onChange:e[1]||(e[1]=c=>a.doSearch(o.value)),onFocusin:e[2]||(e[2]=(...c)=>a.onFocusin&&a.onFocusin(...c)),onInput:e[3]||(e[3]=(...c)=>a.onInput&&a.onInput(...c)),onFocusout:e[4]||(e[4]=(...c)=>a.onFocusout&&a.onFocusout(...c))},null,42,Q),[[C,o.value]]),r(i,{class:"absolute right-4 top-1 hover:text-primary-red transition hover:scale-105 duration-200",icon:"search"}),r(A,{name:"el-zoom-in-top"},{default:u(()=>[j(f("div",X,[(p(!0),m(x,null,k(o.hintList,(c,l)=>(p(),m("button",{onClick:g=>a.clickSearch(c),key:l,style:{"font-size":"inherit"},class:"px-4 py-4 w-full text-left"},b(c),9,Y))),128))],512),[[R,o.showList]])]),_:1})])}var ee=v(M,[["render",Z],["__scopeId","data-v-41d8a87a"]]);const te={emits:["linkto","update:modelValue"],props:{opts:{default:()=>[]},modelValue:{default:()=>0}},watch:{modelValue(t){this.selectedIndex=t}},data(){return{tab:"hover:text-white transition duration-300",selectedIndex:this.modelValue}},methods:{linktoEvent(t,e){this.selectedIndex=e,this.$emit("linkto",t,e),this.$emit("update:modelValue",e)}}},ne={class:"grid grid-flow-col grid-rows-1"},oe=["onClick"];function ae(t,e,n,s,o,a){const i=d("font-awesome-icon");return p(),m("div",ne,[(p(!0),m(x,null,k(n.opts,(c,l)=>(p(),m("button",{class:P(["antialiased",[o.tab,o.selectedIndex==l?"text-white font-semibold":""]]),key:l,onClick:g=>a.linktoEvent(c,l)},[f("span",null,[r(i,{icon:c.icon},null,8,["icon"]),G("\xA0\u2009"+b(c.text),1)])],10,oe))),128))])}var se=v(te,[["render",ae]]);const ie={emits:["quit-login"],props:{username:{default:()=>"LikeGhost"},avatar:{default:()=>"https://avatars.githubusercontent.com/u/55338151?v=4"}},data(){return{opts:[{text:"\u4E2A\u4EBA\u4E2D\u5FC3",icon:"user"},{text:"\u6536\u85CF\u5939",icon:"heart"},{text:"\u6D88\u606F\u901A\u77E5",icon:"envelope"}]}}},ce={class:"flex justify-between items-center mx-auto"},re={class:"grid grid-cols-1 divide-y divide-primary-gray"},de={class:"text-primary-gray cursor-pointer"};function le(t,e,n,s,o,a){const i=d("el-image"),c=d("font-awesome-icon"),l=d("el-popover");return p(),m("div",ce,[r(l,{placement:"bottom",width:"150px",trigger:"hover"},{reference:u(()=>[r(i,{class:"rounded-full w-8 h-8",src:n.avatar},null,8,["src"])]),default:u(()=>[f("div",re,[(p(!0),m(x,null,k(o.opts,g=>(p(),m("button",{key:g,class:"text-left px-4 py-4 active:bg-white flex justify-between items-center ripple"},[r(c,{class:"text-primary-red",icon:g.icon},null,8,["icon"]),G(" "+b(g.text),1)]))),128))])]),_:1}),f("div",de,b(n.username),1),r(c,{onClick:e[0]||(e[0]=g=>t.$emit("quit-login")),class:"text-primary-gray text-lg hover:text-white transition duration-200",icon:"sign-out-alt"})])}var pe=v(ie,[["render",le]]),me=`{
    "data": [
        {
            "id": 0,
            "type": "eval",
...
}`;let y=JSON.parse(me),_=JSON.parse(ue),_e=JSON.parse(he),be=JSON.parse(ge),ve=JSON.parse(fe);var ye={getGameReports(t,e=0){return y.data.filter(n=>n.type=="report").slice(e,t)},getGameEvalByGame(t){return y.data.find(e=>e.gameId==t&&e.type=="eval")},getDeveloperMessage(t){return y.data.find(e=>e.gameId==t&&e.type=="devmsg")},getGameEvals(t,e=0){return y.data.filter(n=>n.type=="eval").slice(e,t)},getGameRanks(t,e=0){return _.data.sort((n,s)=>s.publicScore-n.publicScore).slice(e,t)},getGameData(t=null,e=0){return _.data.slice(e,t)},getGameDataAll(){return _.data},getGameDateById(t){return _.data.find(e=>e.id==t)},getHotGames(t){return _.data.sort((e,n)=>n.hotPoint-e.hotPoint).slice(0,t)},getAd(){return ve.data},getPostContent(t){return be.data.find(e=>e.id==t)},getGameComments(t){return _e.data.filter(e=>e.gameId==t)}};const we={data(){return{logoSrc:q,routeTable:new Map([["/index",{text:"\u9996\u9875",icon:"home"}],["/gamecenter",{text:"\u6E38\u620F\u4E2D\u5FC3",icon:"gamepad"}],["/rank",{text:"\u6392\u884C\u699C",icon:"crown"}]]),routeIndex:0}},watch:{$route(t,e){this.routeIndex=[...this.routeTable.keys()].findIndex(n=>n==t.path)}},methods:{routeTo(t,e){let n=[...this.routeTable.keys()];this.$router.push(n[e])},search(t){return ye.getGameData(5).filter(n=>{let s=new RegExp(`.*${t}.*`);return s.test(n.name)||s.test(n.desc)}).map(n=>n.name)}},components:{SearchBar:ee,PageTabs:se,UserPanel:pe}},xe={class:"bg-fixed bg-background min-h-full"},ke=f("div",{style:{"min-height":"60px"},class:"bg-none"},"cemu.com",-1),Ie={class:"p-0 h-full w-full"};function je(t,e,n,s,o,a){const i=d("el-col"),c=d("el-image"),l=d("PageTabs"),g=d("SearchBar"),L=d("UserPanel"),N=d("el-row"),E=d("el-header"),T=d("router-view"),D=d("el-container");return p(),m("div",xe,[r(D,{direction:"vertical",class:"h-full"},{default:u(()=>[ke,r(E,{height:"60px",class:"bg-primary-black text-primary-gray fixed w-full z-50"},{default:u(()=>[r(N,{gutter:0,class:"h-16",align:"middle",justify:"space-between"},{default:u(()=>[r(i,{span:4}),r(i,{span:2,offset:0},{default:u(()=>[r(c,{class:"w-12 h-12 cursor-pointer",onClick:e[0]||(e[0]=I=>a.routeTo("/index")),src:o.logoSrc},null,8,["src"])]),_:1}),r(i,{span:6,offset:0},{default:u(()=>[r(l,{class:"w-80 h-6 text-sm divide-x divide-primary-gray",onLinkto:a.routeTo,opts:[...o.routeTable.values()],modelValue:o.routeIndex,"onUpdate:modelValue":e[1]||(e[1]=I=>o.routeIndex=I),icons:["home","gamepad","crown"]},null,8,["onLinkto","opts","modelValue"])]),_:1}),r(i,{span:7,offset:0},{default:u(()=>[r(g,{class:"w480 h-7 text-sm bg-primary-black text-primary-gray border-primary-gray border-2 rounded-3xl",getHints:a.search,placeholder:"\u6218\u57302042\u9996\u53D1\u53E3\u7891\u5D29\u574F \u591A\u534A\u5DEE\u8BC4",iptClass:"focus:text-white"},null,8,["getHints"])]),_:1}),r(i,{span:3,offset:0},{default:u(()=>[r(L,{class:"bg-none w-48 h-8"})]),_:1}),r(i,{span:2})]),_:1})]),_:1}),f("div",Ie,[r(T)])]),_:1})])}var Pe=v(we,[["render",je]]);const Ge="modulepreload",S={},Se="/cemu_vue/",h=function(e,n){return!n||n.length===0?e():Promise.all(n.map(s=>{if(s=`${Se}${s}`,s in S)return;S[s]=!0;const o=s.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${a}`))return;const i=document.createElement("link");if(i.rel=o?"stylesheet":Ge,o||(i.as="script",i.crossOrigin=""),i.href=s,document.head.appendChild(i),o)return new Promise((c,l)=>{i.addEventListener("load",c),i.addEventListener("error",l)})})).then(()=>e())},Le=[{path:"/",component:()=>h(()=>import("./Welcome.081d8411.js"),["assets/Welcome.081d8411.js","assets/Welcome.2d64820e.css","assets/Index.f03e9223.js","assets/Index.6650512b.css","assets/RankCardItem.fe58d4cb.js","assets/RankCardItem.fed1caed.css","assets/vendor.434dc5a9.js"])},{path:"/welcome",component:()=>h(()=>import("./Welcome.081d8411.js"),["assets/Welcome.081d8411.js","assets/Welcome.2d64820e.css","assets/Index.f03e9223.js","assets/Index.6650512b.css","assets/RankCardItem.fe58d4cb.js","assets/RankCardItem.fed1caed.css","assets/vendor.434dc5a9.js"])},{path:"/index",component:()=>h(()=>import("./Index.f03e9223.js"),["assets/Index.f03e9223.js","assets/Index.6650512b.css","assets/RankCardItem.fe58d4cb.js","assets/RankCardItem.fed1caed.css","assets/vendor.434dc5a9.js"])},{path:"/login",component:()=>h(()=>import("./Login.d9436d67.js"),["assets/Login.d9436d67.js","assets/slide-anim.d161f90c.css","assets/vendor.434dc5a9.js"])},{path:"/community",component:()=>h(()=>import("./Community.62d555da.js"),[])},{path:"/compost",component:()=>h(()=>import("./Post.44a0ada6.js"),[])},{path:"/gamecenter",component:()=>h(()=>import("./GameCenter.4d050393.js"),["assets/GameCenter.4d050393.js","assets/GameCenter.f133fabd.css","assets/slide-anim.d161f90c.css","assets/GamesGuide.cf4ea750.js","assets/AnimNum.9a76a141.js","assets/vendor.434dc5a9.js"])},{path:"/gamedetail",component:()=>h(()=>import("./GameDetail.9a1cf07d.js"),["assets/GameDetail.9a1cf07d.js","assets/GameDetail.153e8d9a.css","assets/GameComment.9ba5d268.js","assets/GameComment.8a518675.css","assets/vendor.434dc5a9.js","assets/AnimNum.9a76a141.js"])},{path:"/rank",component:()=>h(()=>import("./GameRank.1a0b07dc.js"),["assets/GameRank.1a0b07dc.js","assets/Pagination.f5586b2c.js","assets/Pagination.44826ad1.css","assets/vendor.434dc5a9.js"])},{path:"/test",component:()=>h(()=>import("./Test.c55a6d3f.js"),["assets/Test.c55a6d3f.js","assets/GameComment.9ba5d268.js","assets/GameComment.8a518675.css","assets/vendor.434dc5a9.js","assets/AnimNum.9a76a141.js","assets/Pagination.f5586b2c.js","assets/Pagination.44826ad1.css","assets/RankCardItem.fe58d4cb.js","assets/RankCardItem.fed1caed.css","assets/GamesGuide.cf4ea750.js"])}],Ne=V({history:O(),routes:Le});function Ee(t){t.use(U,{locale:$})}F.add(z);var Te=t=>{t.component("font-awesome-icon",J)};const w=H(Pe);Ee(w);Te(w);w.use(Ne);w.mount("#app");export{v as _,ye as a};
