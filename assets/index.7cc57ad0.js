import{r as d,o as u,c as m,a as f,w as k,v as C,b as r,n as P,d as h,e as S,F as I,f as j,t as v,T as R,g as G,h as A,i as O,j as $,z as U,l as F,_ as H,k as z,m as J}from"./vendor.434dc5a9.js";const B=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerpolicy&&(a.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?a.credentials="include":n.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=o(n);fetch(n.href,a)}};B();var q="/cemu_vue/assets/logo.0c747f41.png";class W{constructor(){this.isLock=!1,this.lockList=[]}async getLock(){let e=this;function o(){let s=e.lockList.shift();s?s.resolve(o):e.isLock=!1}return this.isLock?new Promise((s,n)=>{this.lockList.push({resolve:s,reject:n})}):(this.isLock=!0,o)}}var w=(t,e)=>{for(const[o,s]of e)t[o]=s;return t};const M={emits:["on-search","update:modelValue"],props:{iptClass:{default:()=>""},placeholder:{default:()=>""},modelValue:String,getHints:{type:Function},throttle:{default:()=>200},maxRes:{default:()=>5}},watch:{modelValue(t){this.value=t},value(t,e){this.$emit("update:modelValue",t,e)}},data(){return{showList:!1,hintList:[],value:this.modelValue||"",keywordStack:[],throttleTimer:null,preshow:0,lock:new W}},methods:{doThrottle(){let t=new Date().getTime(),e=t-this.preshow;return this.preshow=t,e<=this.throttle},async onInput(t){let e=await this.lock.getLock();this.keywordStack.push(this.value),e(),!this.doThrottle()&&this.searchHint(this.value)},searchHint(t){this.showList=!0,this.hintList=this.getHints(t).slice(0,this.maxRes)},onFocusout(t){setTimeout(()=>{this.showList=!1},150),clearInterval(this.throttleTimer),this.throttleTimer=null,this.keywordStack=[]},onFocusin(t){this.throttleTimer=setInterval(async()=>{let e=await this.lock.getLock();if(this.keywordStack.length==0||this.doThrottle()){e();return}let o=this.keywordStack.pop();this.keywordStack=[],e(),this.searchHint(o)},this.throttle)},clickSearch(t){this.value=t}}},K=["placeholder"],Q={class:"mt-1 px-3 border-b border-l border-r rounded w-11/12 ml-2 h-fit grid grid-cols-1 divide-y divide-primary-gray",style:{"background-color":"inherit",color:"inherit","border-color":"inherit","box-shadow":"3px 5px 15px #333333"}},X=["onClick"];function Y(t,e,o,s,n,a){const i=d("font-awesome-icon");return u(),m("div",null,[f("div",{class:P(["flex justify-center items-center w-full h-full",o.iptClass])},[k(f("input",{"onUpdate:modelValue":e[0]||(e[0]=c=>n.value=c),type:"text",class:"bg-none border-none p-0 m-0 w-11/12 h-full s-input px-1",placeholder:o.placeholder,onChange:e[1]||(e[1]=c=>t.$emit("on-search",n.value)),onFocusin:e[2]||(e[2]=(...c)=>a.onFocusin&&a.onFocusin(...c)),onInput:e[3]||(e[3]=(...c)=>a.onInput&&a.onInput(...c)),onFocusout:e[4]||(e[4]=(...c)=>a.onFocusout&&a.onFocusout(...c))},null,40,K),[[C,n.value]]),r(i,{class:"w-1/12 hover:text-primary-red transition hover:scale-105 duration-200",icon:"search"})],2),r(R,{name:"el-zoom-in-top"},{default:h(()=>[k(f("div",Q,[(u(!0),m(I,null,j(n.hintList,(c,l)=>(u(),m("button",{onClick:g=>a.clickSearch(c),key:l,style:{"font-size":"inherit"},class:"px-4 py-4 w-full text-left"},v(c),9,X))),128))],512),[[S,n.showList]])]),_:1})])}var Z=w(M,[["render",Y],["__scopeId","data-v-b3d3ef4c"]]);const ee={emits:["linkto","update:modelValue"],props:{opts:{default:()=>[]},modelValue:{default:()=>0}},watch:{modelValue(t){this.selectedIndex=t}},data(){return{tab:"hover:text-white transition duration-300",selectedIndex:this.modelValue}},methods:{linktoEvent(t,e){this.selectedIndex=e,this.$emit("linkto",t,e),this.$emit("update:modelValue",e)}}},te={class:"grid grid-flow-col grid-rows-1"},ne=["onClick"];function oe(t,e,o,s,n,a){const i=d("font-awesome-icon");return u(),m("div",te,[(u(!0),m(I,null,j(o.opts,(c,l)=>(u(),m("button",{class:P(["antialiased",[n.tab,n.selectedIndex==l?"text-white font-semibold":""]]),key:l,onClick:g=>a.linktoEvent(c,l)},[f("span",null,[r(i,{icon:c.icon},null,8,["icon"]),G("\xA0\u2009"+v(c.text),1)])],10,ne))),128))])}var ae=w(ee,[["render",oe]]);const se={emits:["quit-login"],props:{username:{default:()=>"LikeGhost"},avatar:{default:()=>"https://avatars.githubusercontent.com/u/55338151?v=4"}},data(){return{opts:[{text:"\u4E2A\u4EBA\u4E2D\u5FC3",icon:"user"},{text:"\u6536\u85CF\u5939",icon:"heart"},{text:"\u6D88\u606F\u901A\u77E5",icon:"envelope"}]}}},ie={class:"flex justify-between items-center mx-auto"},ce={class:"grid grid-cols-1 divide-y divide-primary-gray"},re={class:"text-primary-gray cursor-pointer"};function de(t,e,o,s,n,a){const i=d("el-image"),c=d("font-awesome-icon"),l=d("el-popover");return u(),m("div",ie,[r(l,{placement:"bottom",width:"150px",trigger:"hover"},{reference:h(()=>[r(i,{class:"rounded-full w-8 h-8",src:o.avatar},null,8,["src"])]),default:h(()=>[f("div",ce,[(u(!0),m(I,null,j(n.opts,g=>(u(),m("button",{key:g,class:"text-left px-4 py-4 active:bg-white flex justify-between items-center ripple"},[r(c,{class:"text-primary-red",icon:g.icon},null,8,["icon"]),G(" "+v(g.text),1)]))),128))])]),_:1}),f("div",re,v(o.username),1),r(c,{onClick:e[0]||(e[0]=g=>t.$emit("quit-login")),class:"text-primary-gray text-lg hover:text-white transition duration-200",icon:"sign-out-alt"})])}var le=w(se,[["render",de]]),pe=`{
    "data": [
        {
            "id": 0,
            "type": "eval",
...
}`;let y=JSON.parse(pe),_=JSON.parse(ue),fe=JSON.parse(me),_e=JSON.parse(he),be=JSON.parse(ge);var ve={getGameReports(t,e=0){return y.data.filter(o=>o.type=="report").slice(e,t)},getGameEvalByGame(t){return y.data.find(e=>e.gameId==t&&e.type=="eval")},getDeveloperMessage(t){return y.data.find(e=>e.gameId==t&&e.type=="devmsg")},getGameEvals(t,e=0){return y.data.filter(o=>o.type=="eval").slice(e,t)},getGameRanks(t,e=0){return _.data.sort((o,s)=>s.publicScore-o.publicScore).slice(e,t)},getGameData(t=null,e=0){return _.data.slice(e,t)},getGameDataAll(){return _.data},getGameDateById(t){return _.data.find(e=>e.id==t)},getHotGames(t){return _.data.sort((e,o)=>o.hotPoint-e.hotPoint).slice(0,t)},getAd(){return be.data},getPostContent(t){return _e.data.find(e=>e.id==t)},getGameComments(t){return fe.data.filter(e=>e.gameId==t)}};const we={data(){return{logoSrc:q,routeTable:new Map([["/index",{text:"\u9996\u9875",icon:"home"}],["/gamecenter",{text:"\u6E38\u620F\u4E2D\u5FC3",icon:"gamepad"}],["/rank",{text:"\u6392\u884C\u699C",icon:"crown"}]]),showSearch:!0,routeIndex:0}},watch:{$route(t,e){this.routeIndex=[...this.routeTable.keys()].findIndex(o=>o==t.path),t.path=="/search"?this.showSearch=!1:this.showSearch=!0}},methods:{routeTo(t,e){if(e!=null){let o=[...this.routeTable.keys()];this.$router.push(o[e])}else this.$router.push(t)},search(t){return ve.getGameData(5).filter(o=>{let s=new RegExp(`.*${t}.*`);return s.test(o.name)||s.test(o.desc)}).map(o=>o.name)}},components:{SearchBar:Z,PageTabs:ae,UserPanel:le}},ye={class:"bg-fixed bg-background min-h-full"},xe=f("div",{style:{"min-height":"60px"},class:"bg-none"},"cemu.com",-1),ke={class:"p-0 h-full w-full"};function Ie(t,e,o,s,n,a){const i=d("el-col"),c=d("el-image"),l=d("PageTabs"),g=d("SearchBar"),E=d("UserPanel"),N=d("el-row"),T=d("el-header"),D=d("router-view"),V=d("el-container");return u(),m("div",ye,[r(V,{direction:"vertical",class:"h-full"},{default:h(()=>[xe,r(T,{height:"60px",class:"bg-primary-black text-primary-gray fixed w-full z-50"},{default:h(()=>[r(N,{gutter:0,class:"h-16",align:"middle",justify:"space-between"},{default:h(()=>[r(i,{span:4}),r(i,{span:2,offset:0},{default:h(()=>[r(c,{class:"w-12 h-12 cursor-pointer",onClick:e[0]||(e[0]=b=>a.routeTo("/index")),src:n.logoSrc},null,8,["src"])]),_:1}),r(i,{span:6,offset:0},{default:h(()=>[r(l,{class:"w-80 h-6 text-sm divide-x divide-primary-gray",onLinkto:a.routeTo,opts:[...n.routeTable.values()],modelValue:n.routeIndex,"onUpdate:modelValue":e[1]||(e[1]=b=>n.routeIndex=b),icons:["home","gamepad","crown"]},null,8,["onLinkto","opts","modelValue"])]),_:1}),r(i,{span:7,offset:0},{default:h(()=>[k(r(g,{class:"w480 h-7 text-sm bg-primary-black text-primary-gray border-primary-gray border-2 rounded-3xl",onOnSearch:e[2]||(e[2]=b=>a.routeTo(`/search?kw=${b}`)),getHints:a.search,placeholder:"\u6218\u57302042\u9996\u53D1\u53E3\u7891\u5D29\u574F \u591A\u534A\u5DEE\u8BC4",iptClass:"focus:text-white"},null,8,["getHints"]),[[S,n.showSearch]])]),_:1}),r(i,{span:3,offset:0},{default:h(()=>[r(E,{class:"bg-none w-48 h-8"})]),_:1}),r(i,{span:2})]),_:1})]),_:1}),f("div",ke,[r(D)])]),_:1})])}var je=w(we,[["render",Ie]]);const Pe="modulepreload",L={},Se="/cemu_vue/",p=function(e,o){return!o||o.length===0?e():Promise.all(o.map(s=>{if(s=`${Se}${s}`,s in L)return;L[s]=!0;const n=s.endsWith(".css"),a=n?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${a}`))return;const i=document.createElement("link");if(i.rel=n?"stylesheet":Pe,n||(i.as="script",i.crossOrigin=""),i.href=s,document.head.appendChild(i),n)return new Promise((c,l)=>{i.addEventListener("load",c),i.addEventListener("error",l)})})).then(()=>e())},Ge=[{path:"/",component:()=>p(()=>import("./Welcome.e68facf2.js"),["assets/Welcome.e68facf2.js","assets/Welcome.2d64820e.css","assets/Index.ec0db4be.js","assets/Index.6650512b.css","assets/RankCardItem.d9e59cbc.js","assets/RankCardItem.fed1caed.css","assets/vendor.434dc5a9.js"])},{path:"/welcome",component:()=>p(()=>import("./Welcome.e68facf2.js"),["assets/Welcome.e68facf2.js","assets/Welcome.2d64820e.css","assets/Index.ec0db4be.js","assets/Index.6650512b.css","assets/RankCardItem.d9e59cbc.js","assets/RankCardItem.fed1caed.css","assets/vendor.434dc5a9.js"])},{path:"/index",component:()=>p(()=>import("./Index.ec0db4be.js"),["assets/Index.ec0db4be.js","assets/Index.6650512b.css","assets/RankCardItem.d9e59cbc.js","assets/RankCardItem.fed1caed.css","assets/vendor.434dc5a9.js"])},{path:"/login",component:()=>p(()=>import("./Login.cbe05e49.js"),["assets/Login.cbe05e49.js","assets/slide-anim.13d7b7a7.css","assets/vendor.434dc5a9.js"])},{path:"/community",component:()=>p(()=>import("./Community.62d555da.js"),[])},{path:"/compost",component:()=>p(()=>import("./Post.44a0ada6.js"),[])},{path:"/gamecenter",component:()=>p(()=>import("./GameCenter.61b32a5f.js"),["assets/GameCenter.61b32a5f.js","assets/GameCenter.f133fabd.css","assets/slide-anim.13d7b7a7.css","assets/GamesGuide.cfb20997.js","assets/AnimNum.9e3f4b90.js","assets/vendor.434dc5a9.js"])},{path:"/gamedetail",component:()=>p(()=>import("./GameDetail.4611e5e5.js"),["assets/GameDetail.4611e5e5.js","assets/GameDetail.153e8d9a.css","assets/GameComment.267d4bdf.js","assets/GameComment.8a518675.css","assets/vendor.434dc5a9.js","assets/AnimNum.9e3f4b90.js"])},{path:"/rank",component:()=>p(()=>import("./GameRank.774cd5bc.js"),["assets/GameRank.774cd5bc.js","assets/RankItem.71c94ab0.js","assets/vendor.434dc5a9.js","assets/Pagination.df6129bc.js","assets/Pagination.91b3dfc6.css"])},{path:"/search",component:()=>p(()=>import("./Search.b9a5ca49.js"),["assets/Search.b9a5ca49.js","assets/Search.5ec92356.css","assets/slide-anim.13d7b7a7.css","assets/Pagination.df6129bc.js","assets/Pagination.91b3dfc6.css","assets/vendor.434dc5a9.js"])},{path:"/test",component:()=>p(()=>import("./Test.e91b9f23.js"),["assets/Test.e91b9f23.js","assets/GameComment.267d4bdf.js","assets/GameComment.8a518675.css","assets/vendor.434dc5a9.js","assets/AnimNum.9e3f4b90.js","assets/RankItem.71c94ab0.js","assets/RankCardItem.d9e59cbc.js","assets/RankCardItem.fed1caed.css","assets/Pagination.df6129bc.js","assets/Pagination.91b3dfc6.css","assets/GamesGuide.cfb20997.js"])}],Le=A({history:O(),routes:Ge});function Ee(t){t.use($,{locale:U})}F.add(H);var Ne=t=>{t.component("font-awesome-icon",z)};const x=J(je);Ee(x);Ne(x);x.use(Le);x.mount("#app");export{Z as S,w as _,ve as a};
